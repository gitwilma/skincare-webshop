    ...
    <main>
      <Box
        ...
        <TextField
          ...
          helperText={form.formState.errors.price?.message?.toString()}
        />
        <TextField
          slotProps={{
          ...
          helperText={form.formState.errors.image?.message?.toString()}
        />
        <TextField
          slotProps={{
          ...
          helperText={form.formState.errors.quantity?.message?.toString()}
        />
        ...
        <FormControl
          ...
          <FormHelperText>
            {form.formState.errors.categoryIds?.message?.toString()}
          </FormHelperText>
        </FormControl>
        <Button
          type='submit'
