          ...
          <Box
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <Typography
                ...
                att sura drycker med levande bakterier är nästa stora grej. Med
                en nästan övernaturlig känsla för trender, har han gått in som
                nyckelinvesterare och gett grönt ljus till att skapa världens
                första kombucha-hemsida med e-handel.
              </Typography>
            </Box>
          </Box>
        </Box>
